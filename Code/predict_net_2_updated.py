...
INPUT_FILE = '/home/ubuntu/Kaggle/net1_results_2.csv'
OUTPUT_FILE = '/home/ubuntu/Kaggle/net2_results_thresh_4.csv'
...
with open(INPUT_FILE, 'rb') as csvfile:
  ...
  for row in reader:
    ...
    if row[1] == "1":
      ...
      if prediction < 1.6650:
        prediction = 1
      elif prediction < 2.5020:
        prediction = 2
      elif prediction < 3.2922:
        prediction = 3
      else:
        prediction = 4
